...
urlpatterns = [
    ...
    path('search/category/', cache_page(views.ProductSearchCategoryListView.as_view(), TIME_OUTS_HOUR),
     ...
     path('search/category_name/', cache_page(views.ProductSearchCategoryNameListView.as_view(), TIME_OUTS_HOUR)),
    path('search/type/', views.ProductSearchTypeListView.as_view(), name='search_type'),
    path('search/type_name/', cache_page(views.ProductSearchTypeNameListView.as_view(), TIME_OUTS_HOUR)),
    ...
    path('type_name/', cache_page(views.ProductTypeNameView.as_view(), TIME_OUTS_HOUR)),
    ...
    path('brand/category/', cache_page(views.ProductBrandCategoryView.as_view(),TIME_OUTS_1DAY),
         name='brand_category'),
    path('brand/category_name/', views.ProductBrandCategoryNameView.as_view()),
    path('brand/type/', cache_page(views.ProductBrandTypeView.as_view(), TIME_OUTS_HOUR), name='brand_type'),
    path('brand/type_name/', cache_page(views.ProductBrandTypeNameView.as_view(), TIME_OUTS_HOUR)),
    ...
    path('category/<str:category>/',
     ...
     path('category_name/<str:category>/', cache_page(views.ProductCategoryNameView.as_view(), TIME_OUTS_HOUR)),
    ...
    path('tag/category_name/', cache_page(views.ProductTagCategoryNameView.as_view(), TIME_OUTS_HOUR)),
    path('tag/type/', cache_page(views.ProductTagTypeView.as_view(), TIME_OUTS_HOUR), name='tag_type'),
    path('tag/type_name/', cache_page(views.ProductTagTypeNameView.as_view(), TIME_OUTS_HOUR)),
